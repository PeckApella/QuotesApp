package com.quote.apps.group.categories;
...
import com.quote.apps.group.Model;
import com.quote.apps.group.R;
...
public class BestWishesh extends AppCompatActivity implements View.OnClickListener{
private AdView adView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Best Wishesh");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("best");
        myShayari = new Model();
